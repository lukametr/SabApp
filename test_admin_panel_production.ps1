# Test admin panel functionality in production
$baseUrl = "https://saba-app-production.up.railway.app"

Write-Host "🧪 Testing Admin Panel in Production" -ForegroundColor Yellow
...
Write-Host "`n🏁 Production admin panel test completed!" -ForegroundColor Yellow
