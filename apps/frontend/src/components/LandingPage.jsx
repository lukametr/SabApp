...
function LandingPage() {
    ...
    var steps = [
        ...
        {
            icon: <icons_material_1.Assignment sx={{ fontSize: 40, color: theme.palette.primary.main }}/>,
            title: 'შეავსე ფორმა',
    ...
    return (<material_1.Box sx={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
        ...
        <material_1.Container maxWidth="lg">
          <material_1.Grid container spacing={4} alignItems="center">
            <material_1.Grid item xs={12} md={6}>
              <material_1.Typography variant="h2" component="h1" gutterBottom sx={{ fontWeight: 'bold' }}>
                შეაფასე უსაფრთხოება ციფრულად
              </material_1.Typography>
              <material_1.Typography variant="h6" component="p" gutterBottom sx={{ mb: 4, opacity: 0.9 }}>
      ...
      <material_1.Box sx={{ py: 8 }}>
        <material_1.Container maxWidth="lg">
          ...
          <material_1.Grid container spacing={4}>
            {steps.map(function (step, index) { return (<material_1.Grid item xs={12} md={4} key={index}>
                <material_1.Card elevation={2} sx={{ textAlign: 'center', p: 3, height: '100%' }}>
                  <material_1.CardContent>
                    <material_1.Box sx={{ mb: 2 }}>
                      <material_1.Chip label={index + 1} color="primary" sx={{ mb: 2, fontSize: 18, fontWeight: 'bold' }}/>
                      {step.icon}
                    </material_1.Box>
      ...
      <material_1.Box id="about" sx={{ py: 8, backgroundColor: 'white' }}>
        <material_1.Container maxWidth="lg">
          ...
          <material_1.Grid container spacing={4}>
            {features.map(function (feature, index) { return (<material_1.Grid item xs={12} sm={6} md={3} key={index}>
          ...
          <material_1.Grid container spacing={4}>
            ...
            gap: 2
                    ...
                    <material_1.Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <material_1.Typography variant="body2" color="text.secondary">შემფასებელი:</material_1.Typography>
                      <material_1.Typography variant="body2">გიორგი ბერიძე</material_1.Typography>
                    </material_1.Box>
                    <material_1.Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <material_1.Typography variant="body2" color="text.secondary">ობიექტი:</material_1.Typography>
                      <material_1.Typography variant="body2">ოფისი №1</material_1.Typography>
                    </material_1.Box>
                    <material_1.Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                      <material_1.Typography variant="body2" color="text.secondary">საფრთხეები:</material_1.Typography>
            ...
            textAlign: 'center'
                    ...
                    <icons_material_1.GetApp sx={{ fontSize: 48, color: theme.palette.primary.main, mb: 2 }}/>
          ...
          <material_1.Grid container spacing={4}>
            <material_1.Grid item xs={12} md={4}>
              <material_1.Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <material_1.Typography variant="h6">SabApp</material_1.Typography>
              </material_1.Box>
            ...
            <material_1.Grid item xs={12} md={4}>
              ...
              <material_1.Stack spacing={1}>
                <material_1.Typography variant="body2" color="grey.400">შეფასების ფორმები</material_1.Typography>
                <material_1.Typography variant="body2" color="grey.400">PDF რეპორტები</material_1.Typography>
                <material_1.Typography variant="body2" color="grey.400">Excel ექსპორტი</material_1.Typography>
              </material_1.Stack>
            </material_1.Grid>
            <material_1.Grid item xs={12} md={4}>
              <material_1.Typography variant="h6" gutterBottom>
