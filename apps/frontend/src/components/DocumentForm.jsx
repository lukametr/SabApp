...
function DocumentForm(_a) {
    ...
    }), control = _c.control, submitForm = _c.handleSubmit, errors = _c.formState.errors, reset = _c.reset;
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (defaultValues) {
            ...
            var formattedHazards = (defaultValues.hazards || []).map(function (hazard) { return ({
    ...
    return (<material_1.Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="document-form-dialog" disableRestoreFocus>
