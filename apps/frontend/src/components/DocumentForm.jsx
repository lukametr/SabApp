...
var PERSONS = ['დასაქმებული', 'ვიზიტორი', 'კონტრაქტორი', 'სხვა პირი', 'ყველა'];
var riskOptions = [0, 1, 2, 3, 4, 5];
function HazardSection(_a) {
  var _this = this;
  var hazards = _a.hazards,
    onHazardsChange = _a.onHazardsChange;
  var _b = (0, react_1.useState)(null),
    expandedHazard = _b[0],
    setExpandedHazard = _b[1];
  var _c = (0, react_1.useState)(null),
    cameraActive = _c[0],
    setCameraActive = _c[1];
  ...
  var updateHazard = function (id, updates) {
    onHazardsChange(
      hazards.map(function (h) {
        return h.id === id ? __assign(__assign({}, h), updates) : h;
      })
    );
  };
  var handleCamera = function (hazardId) {
  ...
  var handleCapture = function (hazardId) {
    ...
    if (videoRef.current) {
      ...
      (_a = canvas.getContext('2d')) === null || _a === void 0
        ? void 0
        : _a.drawImage(videoRef.current, 0, 0);
      canvas.toBlob(function (blob) {
        if (blob) {
          ...
          reader_1.onloadend = function () {
            ...
            var hazard = hazards.find(function (h) {
              return h.id === hazardId;
            });
            if (hazard) {
    ...
    if (hazard) {
      ...
      if (person === 'ყველა') {
        ...
        updated = hazard.affectedPersons.includes(person)
          ? hazard.affectedPersons.filter(function (p) {
              return p !== person;
            })
      ...
      {hazards.map(function (hazard, index) {
        return (
          <material_1.Accordion
            ...
            onChange={function () {
              return setExpandedHazard(expandedHazard === hazard.id ? null : hazard.id);
            }}
            sx={{ mb: 2 }}
          >
              ...
              <material_1.Grid container spacing={2}>
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { hazardIdentification: e.target.value });
                    }}
                  />
                </material_1.Grid>

                <material_1.Grid item xs={12}>
                  <material_1.Typography fontWeight={500} mb={1}>
                  ...
                  <material_1.Box display="flex" gap={2} alignItems="center">
                    <material_1.Button
                      variant="outlined"
                      onClick={function () {
                        return handleCamera(hazard.id);
                      }}
                      startIcon={<PhotoCamera_1.default />}
                      sx={{ minWidth: 0 }}
                    >
                      კამერა
                    </material_1.Button>
                    ...
                    <input
                      ...
                      style={{ display: 'none' }}
                      onChange={function (e) {
                        return handleFileChange(hazard.id, e);
                      }}
                    />
                    {hazard.mediaPreview && (
                      <material_1.Chip
                  ...
                  {cameraActive === hazard.id && (
                    <material_1.Box mt={2}>
                      ...
                      <material_1.Button
                        onClick={function () {
                          return handleCapture(hazard.id);
                        }}
                        variant="contained"
                        sx={{ mt: 1 }}
                      >
                  ...
                  {hazard.mediaPreview && cameraActive !== hazard.id && (
                    <material_1.Box mt={2}>
                      <image_1.default
                        ...
                        onLoad={function () {
                          return console.log('✅ Preview image loaded for hazard:', hazard.id);
                        }}
                        onError={function (e) {
                          return console.error('❌ Preview image failed to load:', e);
                        }}
                      />
                    </material_1.Box>
                  )}
                  ...
                  {hazard.photos && hazard.photos.length > 0 && !hazard.mediaPreview && (
                    <material_1.Box mt={2}>
                      <material_1.Typography variant="body2" mb={1}>
                        შენახული ფოტოები:
                      </material_1.Typography>
                      <material_1.Box display="flex" flexWrap="wrap" gap={1}>
                        {hazard.photos.map(function (base64Photo, index) {
                          return (
                            <material_1.Box key={index} position="relative">
                              <image_1.default
                                src={base64Photo} // base64 data URL
                                alt={'\u10E4\u10DD\u10E2\u10DD '.concat(index + 1)}
                                width={150}
                                height={120}
                                unoptimized
                              ...
                              <material_1.IconButton
                                size="small"
                                onClick={function () {
                                  var updatedPhotos = hazard.photos.filter(function (_, i) {
                                    return i !== index;
                                  });
                            ...
                            <material_1.Checkbox
                              checked={
                                ...
                                person === 'ყველა'
                                  ...
                                  : hazard.affectedPersons.includes('ყველა') ||
                                    hazard.affectedPersons.includes(person)
                              }
                              onChange={function () {
                                return handlePersonChange(hazard.id, person);
                              }}
                            />
                          }
                          label={person}
                ...
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { injuryDescription: e.target.value });
                    }}
                  />
                </material_1.Grid>
                ...
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { existingControlMeasures: e.target.value });
                    }}
                  />
                </material_1.Grid>
                    ...
                    <material_1.TextField
                      ...
                      onChange={function (e) {
                        ...
                        updateHazard(hazard.id, {
                          initialRisk: __assign(__assign({}, hazard.initialRisk), {
                            probability: prob,
                            total: total,
                          }),
                        });
                ...
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { additionalControlMeasures: e.target.value });
                    }}
                  />
                </material_1.Grid>
                ...
                <material_1.Grid item xs={12}>
                  ...
                  <material_1.Box display="flex" gap={2}>
                    <material_1.TextField
                      ...
                      onChange={function (e) {
                        ...
                        updateHazard(hazard.id, {
                          residualRisk: __assign(__assign({}, hazard.residualRisk), {
                            probability: prob,
                            total: total,
                          }),
                        });
                  ...
                  {hazard.residualRisk.total >= 9 && (
                    <material_1.Alert severity="warning" sx={{ mt: 1 }}>
                ...
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { requiredMeasures: e.target.value });
                    }}
                  />
                </material_1.Grid>
                ...
                <material_1.Grid item xs={12}>
                  <material_1.TextField
                    ...
                    onChange={function (e) {
                      return updateHazard(hazard.id, { responsiblePerson: e.target.value });
                    }}
                  />
                </material_1.Grid>
...
function DocumentForm(_a) {
  var _this = this;
  var handleFormSubmit = _a.onSubmit,
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      if (defaultValues) {
        ...
        var formattedHazards = (defaultValues.hazards || []).map(function (hazard) {
          return {
        ...
        console.log('✅ Form reset with values:', {
          ...
          photosCount:
            ((_a = defaultValues.photos) === null || _a === void 0 ? void 0 : _a.length) || 0,
        });
      } else {
        // Reset to empty form
        setHazards([]);
  ...
  var handleFormSubmitInternal = function (data) {
    return __awaiter(_this, void 0, void 0, function () {
        ...
        switch (_a.label) {
          case 0:
            ...
            console.log('📊 Form submission data:', {
              ...
              hazardPhotos: hazards.map(function (h) {
                return {
                  id: h.id,
      ...
      <material_1.DialogTitle id="document-form-dialog">
        <material_1.Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          <material_1.Box sx={{ display: 'flex', gap: 2 }}>
            <material_1.Button variant="outlined" onClick={onCancel}>
              გაუქმება
            </material_1.Button>
