        ...
        if (hazard) {
            ...
            if (person === 'ყველა') {
                ...
                updated = hazard.affectedPersons.includes(person)
                    ...
                    : __spreadArray(__spreadArray([], hazard.affectedPersons.filter(function (p) { return p !== 'ყველა'; }), true), [person], false);
            }
            ...
            <material_1.Grid container spacing={2}>
              ...
              <material_1.Grid item xs={12}>
                ...
                {hazard.mediaPreview && cameraActive !== hazard.id && (<material_1.Box mt={2}>
                    <image_1.default src={hazard.mediaPreview} alt="preview" width={200} height={150} style={{ maxWidth: 200, borderRadius: 8, objectFit: 'cover' }}/>
                  </material_1.Box>)}
              </material_1.Grid>
              ...
              <material_1.Grid item xs={12}>
                <x_date_pickers_1.LocalizationProvider dateAdapter={AdapterDateFns_1.AdapterDateFns} adapterLocale={locale_1.ka}>
                  <x_date_pickers_1.DatePicker label="გადახედვის სავარაუდო დრო" value={hazard.reviewDate} onChange={function (date) { return date && updateHazard(hazard.id, { reviewDate: date }); }} slotProps={{
                textField: {
                    fullWidth: true,
                    required: true
                }
...
function DocumentForm(_a) {
    ...
    var _c = (0, react_1.useState)((_b = defaultValues === null || defaultValues === void 0 ? void 0 : defaultValues.hazards) !== null && _b !== void 0 ? _b : []), hazards = _c[0], setHazards = _c[1];
    ...
    }), control = _d.control, submitForm = _d.handleSubmit, errors = _d.formState.errors;
    ...
    return (<material_1.Dialog open={open} onClose={onClose} maxWidth="md" fullWidth aria-labelledby="document-form-dialog">
