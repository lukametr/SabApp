      ...
      <material_1.Container maxWidth="sm">
        <material_1.Paper elevation={3} sx={{ p: 4, textAlign: 'center' }}>
          ...
          {success && (<material_1.Box>
              ...
              <material_1.Button variant="contained" size="large" onClick={function () { return router.push('/auth/login'); }} sx={{ mr: 2 }}>
                შესვლა
              </material_1.Button>
              <material_1.Button variant="outlined" size="large" onClick={function () { return router.push('/'); }}>
                მთავარი გვერდი
              </material_1.Button>
            </material_1.Box>)}
          ...
          {error && (<material_1.Box>
              ...
              <material_1.Button variant="outlined" size="large" onClick={function () { return router.push('/auth/register'); }} sx={{ mr: 2 }}>
                რეგისტრაცია
              </material_1.Button>
              <material_1.Button variant="outlined" size="large" onClick={function () { return router.push('/'); }}>
                მთავარი გვერდი
