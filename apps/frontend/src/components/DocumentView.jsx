      ...
      <material_1.CardContent>
        ...
        <material_1.Grid container spacing={2}>
          ...
          <material_1.Grid item xs={12} md={6}>
            ...
            <material_1.Typography variant="body1">
              {document.date && !isNaN(new Date(document.date).getTime()) ? (0, date_fns_1.format)(new Date(document.date), 'dd MMMM yyyy', { locale: locale_1.ka }) : 'არავალიდური თარიღი'} {document.time && !isNaN(new Date(document.time).getTime()) ? (0, date_fns_1.format)(new Date(document.time), 'HH:mm') : 'არავალიდური დრო'}
            </material_1.Typography>
          </material_1.Grid>
                ...
                <material_1.AccordionDetails>
                  <material_1.Grid container spacing={2}>
                    ...
                    <material_1.Grid item xs={12} md={6}>
                      ...
                      <material_1.Typography variant="body1">
                        {hazard.reviewDate && !isNaN(new Date(hazard.reviewDate).getTime()) ? (0, date_fns_1.format)(new Date(hazard.reviewDate), 'dd MMMM yyyy', { locale: locale_1.ka }) : 'არ არის მითითებული'}
                      </material_1.Typography>
                    </material_1.Grid>
