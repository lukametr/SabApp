    ...
    (0, react_1.useEffect)(function () {
        ...
        if (window.google && window.google.accounts) {
            ...
            try {
                ...
                window.google.accounts.id.initialize(__assign({ client_id: clientId, callback: handleGoogleSuccess, auto_select: false, cancel_on_tap_outside: true, prompt_parent_id: 'google-signin-container', ux_mode: 'popup', scope: 'openid email profile', locale: 'ka' }, (isMobile && {
                    context: 'signin',
                    itp_support: true,
                })));
            ...
            <div className="hidden sm:flex sm:items-center sm:space-x-4">
              {!user && (<>
                  ...
                  <div id="google-signin-container">
                    {authError && (<div className="mb-2 p-2 bg-red-100 border border-red-400 text-red-700 rounded text-xs">
                        {authError}
                      </div>)}
                    <button onClick={function () { return router.push('/auth/login'); }} className="px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 flex items-center">
