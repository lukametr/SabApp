...
function Navigation() {
  ...
  var _b = (0, react_1.useState)(false),
    showRegistration = _b[0],
    setShowRegistration = _b[1];
  var _c = (0, react_1.useState)(null),
    pendingIdToken = _c[0],
    setPendingIdToken = _c[1];
  var _d = (0, react_1.useState)(null),
    pendingUserInfo = _d[0],
    setPendingUserInfo = _d[1];
  ...
  var handleGoogleSuccess = (0, react_1.useCallback)(
        ...
        return __generator(this, function (_h) {
          switch (_h.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                api_1.default.post('/auth/google', {
                  idToken: idToken,
              ...
              if (
                ...
                setAuthError(
                  'ავტორიზაციის შეცდომა: ' +
                    (((_e =
                      (_d = error === null || error === void 0 ? void 0 : error.response) ===
                        null || _d === void 0
                        ? void 0
            ...
            case 5:
              ...
              setAuthError(
                'ავტორიზაციის შეცდომა: ' +
                  (((_g =
                    (_f = error === null || error === void 0 ? void 0 : error.response) === null ||
                    _f === void 0
                      ? void 0
          ...
          switch (_f.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fetch(
                  'https://www.googleapis.com/oauth2/v2/userinfo?access_token='.concat(
  ...
  var handleRegistrationSubmit = function (data) {
    return __awaiter(_this, void 0, void 0, function () {
      var res, err_4, error;
      var _a, _b;
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            if (!pendingIdToken) return [2 /*return*/];
            setLoading(true);
            setAuthError('');
            _c.label = 1;
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.default.post('/auth/google/complete-registration', {
