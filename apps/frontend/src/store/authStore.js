...
exports.useAuthStore = (0, zustand_1.create)(function (set, get) {
  return __assign(__assign({}, initializeAuth()), {
    user: null,
    token: null,
    loading: true,
    error: null,
        ...
        return __generator(this, function (_d) {
          try {
            console.log('🗃️ AuthStore login:', {
              ...
              userEmail:
                (_a = data === null || data === void 0 ? void 0 : data.user) === null ||
                _a === void 0
                  ? void 0
                  : _a.email,
            });
            ...
            if (typeof window !== 'undefined') {
              console.log('🗃️ Saving to localStorage:', {
                token:
                  ((_b = data.accessToken) === null || _b === void 0
                    ? void 0
                    : _b.substring(0, 20)) + '...',
    ...
    loadFromStorage: function () {
      ...
      try {
        ...
        console.log('🗃️ Storage data found:', {
          ...
          hasUser: !!user,
          tokenPrefix:
            (token === null || token === void 0 ? void 0 : token.substring(0, 20)) + '...' ||
            'none',
        });
        if (token && user) {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 3:
              ...
              if (
                ((_a = error_1.response) === null || _a === void 0 ? void 0 : _a.status) === 401
              ) {
