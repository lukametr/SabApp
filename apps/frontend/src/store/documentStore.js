    ...
    updateDocument: function (data) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    updatedDocument_1 = _b.sent();
                    console.log('✅ Store received updated document:', {
                        id: updatedDocument_1.id,
                        objectName: updatedDocument_1.objectName,
                        hazardsCount: ((_a = updatedDocument_1.hazards) === null || _a === void 0 ? void 0 : _a.length) || 0
                    });
                    set(function (state) {
                        var _a;
                        return ({
                ...
                case 3:
                    error_5 = _b.sent();
                    console.error('❌ Store document update failed:', error_5);
