...
export default function AboutPage() {
  const content = `sabapp-ის მთავარი მიზანია შრომის უსაფრთხოების სპეციალისტებისთვის რისკების შეფასების დოკუმენტაციის წარმოებისა და მართვის პროცესი გავხადოთ მარტივი, ციფრული და სტანდარტებთან შესაბამისი.
