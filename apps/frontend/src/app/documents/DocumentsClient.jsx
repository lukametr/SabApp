...
exports.default = DocumentsClient;
var react_1 = __importStar(require("react"));
var material_1 = require("@mui/material");
var icons_material_1 = require("@mui/icons-material");
var DocumentList_1 = __importDefault(require("../../components/DocumentList"));
var DocumentForm_1 = __importDefault(require("../../components/DocumentForm"));
...
function DocumentsClient() {
    ...
    var convertDocumentToCreateDto = function (doc) {
        ...
        console.log('🔄 Converting document to DTO:', {
            ...
            hazardsCount: ((_a = doc.hazards) === null || _a === void 0 ? void 0 : _a.length) || 0,
            photosCount: ((_b = doc.photos) === null || _b === void 0 ? void 0 : _b.length) || 0
        });
        return {
    ...
    return (<material_1.Box p={3}>
      ...
      <DocumentList_1.default documents={documents} onEdit={handleEdit} onDelete={handleDeleteClick}/>
