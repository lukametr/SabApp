...
function TermsPage() {
    ...
    return (<material_1.Box sx={{ minHeight: '100vh', backgroundColor: '#f5f5f5', py: 4 }}>
      <material_1.Container maxWidth="md">
        <material_1.Paper elevation={3} sx={{ p: 4 }}>
          ...
          <material_1.Typography variant="body2" color="text.secondary" sx={{ mt: 4, textAlign: 'center' }}>
            ბოლო განახლება: 2025 წლის 7 იანვარი
          </material_1.Typography>

          <material_1.Box sx={{ textAlign: 'center', mt: 4 }}>
            <material_1.Button variant="contained" onClick={function () { return router.back(); }} sx={{ px: 4 }}>
              უკან დაბრუნება
            </material_1.Button>
          </material_1.Box>
        </material_1.Paper>
