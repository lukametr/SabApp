      ...
      <Container maxWidth="md">
        <Paper elevation={3} sx={{ p: 4 }}>
          ...
          <Typography variant="body1" paragraph>
            ჩვენი პლატფორმის გამოყენებით თქვენ ეთანხმებით ქვემოთ მოცემულ წესებსა და პირობებს. 
            პლატფორმა შექმნილია უსაფრთხოების ოფიცრებისთვის დოკუმენტების მართვისა და შეფასების ფორმების შესავსებად.
          </Typography>
