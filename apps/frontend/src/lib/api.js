...
api.interceptors.request.use(
  function (config) {
    ...
    console.log('🚀 API Request:', {
      ...
      fullURL: config.url
        ? ''.concat(config.baseURL, '/').concat(config.url).replace(/\/+/g, '/')
        : config.baseURL,
    });
...
api.interceptors.response.use(
  ...
  function (error) {
    ...
    console.error('❌ API Error:', {
      ...
      fullURL: ((_f = error.config) === null || _f === void 0 ? void 0 : _f.url)
        ? ''
            .concat((_g = error.config) === null || _g === void 0 ? void 0 : _g.baseURL, '/')
            .concat((_h = error.config) === null || _h === void 0 ? void 0 : _h.url)
            .replace(/\/+/g, '/')
        : (_j = error.config) === null || _j === void 0
          ? void 0
          : _j.baseURL,
    });
